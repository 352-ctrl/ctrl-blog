...
import com.example.blog.dto.report.ReportProcessDTO;
import com.example.blog.dto.report.ReportQueryDTO;
...
import com.example.blog.manager.builder.ReportContextBuilder;
import com.example.blog.mapper.ReportMapper;
import com.example.blog.service.*;
import com.example.blog.utils.UserContext;
import com.example.blog.vo.AdminReportVO;
    ...
    public void processReport(ReportProcessDTO processDTO) {
        ...
        if (BizStatus.ReportStatus.VALID.equals(newStatus)) {
            ...
            if (BizStatus.ReportTargetType.COMMENT.equals(targetType)) {
                // 删除违规评论并获取评论作者ID
                com.example.blog.entity.Comment comment = commentService.getById(targetId);
