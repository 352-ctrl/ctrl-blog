 ...
 * =========================================================================
 * 声明：
 * 本行为验证码（滑动拼图/点选）组件核心代码抽取自开源项目 AJ-Captcha。
 * 原项目主页：https://gitee.com/belief-team/captcha
 * 本项目在此基础上进行了 Vue 3 的适配与 UI 定制，特此致谢原作者团队。
 * =========================================================================
 */
    ...
    import {resetSize} from '../../../utils/common.js'
    import {reqGet,reqCheck}  from "../../../api/common/verify.js"
    ...
    export default {
        ...
        setup(props,context){
            ...
            let secretKey = ref(''),           //后端返回的ase加密秘钥
                ...
                leftBarBorderColor = ref('var(--el-border-color)'),
                ...
                const refresh = ()=>{
                    ...
                    moveBlockBackgroundColor.value = 'var(--el-bg-color)'
                    iconColor.value = 'var(--el-text-color-primary)'
